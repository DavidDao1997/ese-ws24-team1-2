...
void HeartBeat::checkConnection(){
    ...
    while (running){
        _pulse msg;
        //Logger::getInstance().log(LogLevel::DEBUG, "FOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOo", "");
        ...
        //Logger::getInstance().log(LogLevel::ERROR, "Timer ", "HeartBeat");   

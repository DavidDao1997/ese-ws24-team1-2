...
enum FsmEvent {
    ...
    // Motor
    EVENT_MOTOR_STOP_REQUEST,
    EVENT_MOTOR_STOP_RESOLVE,
    EVENT_MOTOR_FAST_REQUEST,
    EVENT_MOTOR_FAST_RESOLVE,
    EVENT_MOTOR_RESET,

    // Ingress
    EVENT_INGRESS_IN,
    EVENT_INGRESS_OUT,
    EVENT_INGRESS_PUKPRESENT_IN,
    EVENT_INGRESS_CREATINGDISTANCE_OUT,
    EVENT_PUK_ENTRY_HEIGHT_MEASUREMENT,

    // HeightMeasurement
    EVENT_HM_PUK_DISTANCE_VALID,
    EVENT_HM_PUKPRESENT_IN,
    EVENT_HM_PUKPRESENT_OUT,
    EVENT_HM_MEASUREMENT_IN,
    EVENT_HM_MEASUREMENT_OUT,

    // Entry to Sorting
    EVENT_HM_PUK_LEAVING_HEIGHTMEASUREMENT,

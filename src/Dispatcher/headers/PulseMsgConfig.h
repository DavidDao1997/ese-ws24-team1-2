...
enum FsmEvent {
    ...
    // Egress
    EVENT_EGRESS_TRANSFER_IN,
    EVENT_EGRESS_TRANSFER_OUT,
    ...
    EVENT_HM_ENTRY_SORTING,

    // Entry to Sorting
    EVENT_HM_PUK_LEAVING_HEIGHTMEASUREMENT,
    EVENT_SORTING_PUKPRESENT_IN,
    EVENT_SORTING_PUKPRESENT_OUT,
    EVENT_SORTING_PUK_ENTRY_EGRESS,
    EVENT_SORTING_RAMP_FULL_IN,
    EVENT_SORTING_RAMP_FULL_OUT,
    EVENT_SORTING_METALMEASUREMENT_IN,
    EVENT_SORTING_METALMEASUREMENT_OUT,
    EVENT_SORTING_PUK_EJECTOR_DISTANCE_VALID,
    EVENT_SORTING_EJECTOR_OUT,
    EVENT_SORTING_PASSTHROUGH_OUT,

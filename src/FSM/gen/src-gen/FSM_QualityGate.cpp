...
bool FSM_QualityGate::dispatchEvent(FSM_QualityGate::EventInstance* event) noexcept
{
	...
	switch(event->eventId)
	{
		...
		case FSM_QualityGate::Event::LBM_1_OPEN:
		{
			LBM_1_OPEN_raised = true;
			break;
		}
		case FSM_QualityGate::Event::MS_TRUE:
		{
			MS_TRUE_raised = true;
			break;
		}
		case FSM_QualityGate::Event::MS_FALSE:
		{
			MS_FALSE_raised = true;
			break;
		}
...
void FSM_QualityGate::raiseLBM_1_OPEN() {
	incomingEventQueue.push_back(new FSM_QualityGate::EventInstance(FSM_QualityGate::Event::LBM_1_OPEN))
	;
	runCycle();
}
...
void FSM_QualityGate::raiseMS_TRUE() {
	incomingEventQueue.push_back(new FSM_QualityGate::EventInstance(FSM_QualityGate::Event::MS_TRUE))
	;
	runCycle();
}
...
void FSM_QualityGate::raiseMS_FALSE() {
	incomingEventQueue.push_back(new FSM_QualityGate::EventInstance(FSM_QualityGate::Event::MS_FALSE))
	;
	runCycle();
}
...
sc::rx::Observable<void>& FSM_QualityGate::getSORTING_MODULE_ACTIVE() noexcept {
	return this->SORTING_MODULE_ACTIVE_observable;
}


sc::rx::Observable<void>& FSM_QualityGate::getSORTING_MODULE_RESTING() noexcept {
	return this->SORTING_MODULE_RESTING_observable;
}
...
sc::rx::Observable<void>& FSM_QualityGate::getLY1_ON() noexcept {
	return this->LY1_ON_observable;
}


sc::rx::Observable<void>& FSM_QualityGate::getLY1_BLINKING_1HZ() noexcept {
	return this->LY1_BLINKING_1HZ_observable;
}


sc::rx::Observable<void>& FSM_QualityGate::getLY1_OFF() noexcept {
	return this->LY1_OFF_observable;
}


sc::rx::Observable<void>& FSM_QualityGate::getLR1_ON() noexcept {
	return this->LR1_ON_observable;
}


sc::rx::Observable<void>& FSM_QualityGate::getLR1_OFF() noexcept {
...
bool FSM_QualityGate::getMetalDetected() const noexcept
{
	return metalDetected
	;
}

void FSM_QualityGate::setMetalDetected(bool metalDetected_) noexcept
{
	this->metalDetected = metalDetected_;
}
...
/* Entry action for state 'Off'. */
void FSM_QualityGate::enact_FSM_Signaling_FSM_LAMP_FSM_LAMP_FSM_Lamp_FSM_Lamp_Yellow_Off()
{
	/* Entry action for state 'Off'. */
...
/* Entry action for state 'Constant'. */
void FSM_QualityGate::enact_FSM_Signaling_FSM_LAMP_FSM_LAMP_FSM_Lamp_FSM_Lamp_Yellow_Constant()
{
	/* Entry action for state 'Constant'. */
...
/* Entry action for state 'Blinking 1Hz'. */
void FSM_QualityGate::enact_FSM_Signaling_FSM_LAMP_FSM_LAMP_FSM_Lamp_FSM_Lamp_Yellow_Blinking_1Hz()
{
	/* Entry action for state 'Blinking 1Hz'. */
...
/* Entry action for state 'Off'. */
void FSM_QualityGate::enact_FSM_Signaling_FSM_LAMP_FSM_LAMP_FSM_Lamp_FSM_Lamp_Red_Off()
{
	/* Entry action for state 'Off'. */
...
/* Entry action for state 'Constant'. */
void FSM_QualityGate::enact_FSM_Signaling_FSM_LAMP_FSM_LAMP_FSM_Lamp_FSM_Lamp_Red_Constant()
{
	/* Entry action for state 'Constant'. */
...
{
	/* 'default' enter sequence for state Off */
	enact_FSM_Signaling_FSM_LAMP_FSM_LAMP_FSM_Lamp_FSM_Lamp_Yellow_Off();
...
{
	/* 'default' enter sequence for state Constant */
	enact_FSM_Signaling_FSM_LAMP_FSM_LAMP_FSM_Lamp_FSM_Lamp_Yellow_Constant();
...
{
	/* 'default' enter sequence for state Blinking 1Hz */
	enact_FSM_Signaling_FSM_LAMP_FSM_LAMP_FSM_Lamp_FSM_Lamp_Yellow_Blinking_1Hz();
...
{
	/* 'default' enter sequence for state Off */
	enact_FSM_Signaling_FSM_LAMP_FSM_LAMP_FSM_Lamp_FSM_Lamp_Red_Off();
...
{
	/* 'default' enter sequence for state Constant */
	enact_FSM_Signaling_FSM_LAMP_FSM_LAMP_FSM_Lamp_FSM_Lamp_Red_Constant();
...
sc::integer FSM_QualityGate::FSM_QualityGate__Sorting_Sorting_Sorting_PukPresent_react(const sc::integer transitioned_before) {
	...
	if ((transitioned_after) < (2))
	{ 
		if (((LBM_1_INTERRUPTED_raised) && (metalDetected)) && (ramp1Full))
		{ 
			exseq_FSM_QualityGate__Sorting_Sorting();
		...
		{
			if ((LBM_1_INTERRUPTED_raised) && (!(metalDetected)))
			{ 
				exseq_FSM_QualityGate__Sorting_Sorting_Sorting_PukPresent();
			...
			}  else
			{
				...
				{ 
					exseq_FSM_QualityGate__Sorting_Sorting_Sorting_PukPresent();
					SORTING_MODULE_ACTIVE_observable.next();
					SORTING_MODULE_RESTING_observable.next();
					enseq_FSM_QualityGate__Sorting_Sorting_Sorting_ejecting_default();
					FSM_QualityGate__Sorting_Sorting_react(2);
					transitioned_after = 2;
				} 
...
void FSM_QualityGate::clearInEvents() noexcept {
	...
	MS_TRUE_raised = false;
	MS_FALSE_raised = false;
